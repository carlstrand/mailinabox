...
apt-fast install aria2 bc bind9 bind9-host build-essential ca-certificates certbot coreutils cron curl dbconfig-common default-jre \
...
openssh-client openssl opendkim php php-apcu php-cli php-common php-curl php-dev php-fpm php-gd php-imap php-intl php-json php-mbstring php-pear php-pspell php-soap php-sqlite3 \
